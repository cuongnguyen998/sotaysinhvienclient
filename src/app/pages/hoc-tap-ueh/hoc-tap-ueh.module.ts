...
@NgModule({
  declarations: [HocTapUehComponent, PortalComponent, EmailComponent, TheSinhVienComponent, ELearningComponent, ThuVienComponent, KhungThoiGianComponent, ThoiGianHocComponent, DangKyHocPhanComponent, MoLopHocPhanComponent, HocPhiComponent, VangThiComponent, PhucKhaoComponent, DanhGiaRenLuyenComponent, ChuyenDiemComponent, NghiHocComponent, NghienCuuComponent, HocPhanKhoaLuanComponent, ChuanDauRaComponent, DieuKienTotNghiepComponent, XepHangTotNghiepComponent, ChuongTrinhClcComponent, ChuongTrinhCntnComponent, ChuongTrinhDtt2Component],
  imports: [
    CommonModule
  ]
})
